...
module.exports = {
    ...
    getTransactionReceipt: function (txid) {
        return get_transaction_receipt(txid)
    },
...
var get_transaction_receipt = function(txid){
    var d = when.defer();
    var tag = TAG+" | get_transaction_receipt | "
    var debug = true
